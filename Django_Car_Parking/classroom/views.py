...
def plate(request):
   ...
   def main():
    ...
    image_path ="C:\\Users\\aliir\\Downloads\\Django Car Parking\\Django_Car_Parking\\media\myimage\\1_2o0oE6D.jpeg"
    ...
    try:
        ...
        # print the overlayed image with OCR results
        output_text = []
        if ocr_preds:
            print(overlayed_ocr)
        ...
        output_text="helloo"
        url="dashboard/dashboard.html/?output{}".format(output_text)    
   ...
   return render(request,'dashboard/dashboard.html',{'out': out})
